...
const AllPosts = () => {
    ...
    const [selectedPost, setSelectedPost] = useState(null); // State to keep track of selected post
    ...
    const handleToken = (post) => {
        ...
        if (!token) {
            ...
            setSelectedPost(post); // Store selected post
    ...
    const ApplyPost = async () => {
        ...
        try {
            ...
            setSelectedPost(null); // Clear selected post after applying
        }
    }
    ...
    return (
        <div className="AllPostss" >
            ...
            <div className="Filter_Branch">
                ...
                <option value="Select Branch">Filter Branch</option>
                                    ...
                                    <div className="row no-gutters">
                                        ...
                                        <div className="col">
                                            <div className="card-body">
                                                ...
                                                <p className="card-text"><b>Address-city: {post.College[0].address}</b></p>
                                                <p className="card-text"><b>College-Url: <a href={post.College[0].link}>Website</a></b></p>
      ...
      <div className={style.messageTextContainer}>
        ...
        <p className={style.subText}>Application Submitted Successfully</p>
      </div>
      <svg
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 15 15"
